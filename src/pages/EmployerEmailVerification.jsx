...
import { employerVerifyEmailWithCode } from "../api";

export default function EmployerEmailVerification() {
  ...
  const handleVerification = async () => {
    ...
    try {
      const response = await employerVerifyEmailWithCode(email, verificationCode);
      ...
      if (pendingData.role === "employer") {
        localStorage.setItem("role", "employer");
        localStorage.setItem("employerId", pendingData.employerId);
  ...
  return (
    <>
      ...
      <main className="mainlogin">
        ...
        <p className="endform" style={{ color: "gray" }}>Verify your employer account email</p>
