    ...
    <>
      ...
      <main className="mainlogin">
        ...
        <div className="empstu">
          <Link className="al actform" to="/forgot-password"><b>Student</b></Link>
          <Link className="al choose" to="/employer-forgot-password"><b>Employer</b></Link>
        </div>
        ...
        <section className="loginform">
          ...
          <p className="endform">
            Remember your password? <Link to="/login" style={{ color: "blue", textDecoration: "none" }}><b>Back to Login</b></Link>
          </p>
        </section>
      </main>
      <Footer />
